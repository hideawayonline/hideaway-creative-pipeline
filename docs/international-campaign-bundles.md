...
- [ ] Shopify Markets: **"International (Worldwide Box)" market created DISABLED** (`gid://shopify/Market/101128470723`, NZ/US/UK/CA/IE/SG) — audit found the store previously had an Australia-only market with no currency localisation. Owner actions in admin (unified markets → API-restricted): enable the market, turn on local currencies, set 0% price adjustment, exclude perfume + mists + Skin to Skin $50 set, configure duties/DDP (Managed Markets) or soften the duties-included FAQ copy\n- [x] Builder quote blocks filled with 4 REAL Judge.me reviews recovered from the `judgeme.featured_carousel` shop-metafield widget cache (Richelle/BE Body Custard, Charlie H./Natural Lubricant, Leisa H. and Keerthi store reviews — verbatim, attributed, perfume-specific reviews excluded)
